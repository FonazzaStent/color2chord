"""Color to Chord 1.0.1 - Convert colors to chords.
...
def inputRGB():
    ...
    R=input("R (q to quit, Enter for random value): ")
    if R=='':
        R=str(randint(1,255))
        print (R)
    if R=='q':
    ...
    if int(R)>255:
        R=255
    G=input("G (q to quit, Enter for random value): ")
    if G=='':
        G=str(randint(1,255))
        print (G)
    if G=='q':
    ...
    if int(G)>255:
        G=255
    B=input("B (q to quit, Enter for random value): ")
    if B=='':
        B=str(randint(1,255))
        print (B)
    if B=='q':
